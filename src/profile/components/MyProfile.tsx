      ...
      <Container>
        ...
        <Box style={{ margin: '2rem 0' }}>
          <Grid container justify="flex-end">
            <Grid item xs={2}>
              <Button variant="contained" color="secondary" fullWidth={true} onClick={(_event) => console.log('Implementation du Logout')}>
                Logout
              </Button>
            </Grid>
            <Grid item xs={2}>
              <Button variant="contained" color="secondary" fullWidth={true} onClick={(_event) => console.log('Implementation du Delete')}>
                Delete account
              </Button>
            </Grid>
          </Grid>
        ...
        <form onSubmit={(e) => { e.preventDefault(); this.saveProfile() }}>
          ...
          <Box style={{ margin: '2rem 0' }}>
            <Grid container justify="space-between">
              <Grid item xs={2}>
                <Button variant="contained" fullWidth={true} onClick={(event) => console.log('Implementation du Reset')}>
                  Reset
                </Button>
              </Grid>
              <Grid item xs={2}>
